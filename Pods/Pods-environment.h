...
// MessageBanner
#define COCOAPODS_POD_AVAILABLE_MessageBanner
#define COCOAPODS_VERSION_MAJOR_MessageBanner 1
#define COCOAPODS_VERSION_MINOR_MessageBanner 0
#define COCOAPODS_VERSION_PATCH_MessageBanner 1
